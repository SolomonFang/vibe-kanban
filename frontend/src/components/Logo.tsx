const GLYPHS = {
  H: ['11000011', '11000011', '11111111', '11111111', '11000011', '11000011'],
  E: ['11111111', '11000000', '11111110', '11111110', '11000000', '11111111'],
  L: ['11000000', '11000000', '11000000', '11000000', '11000000', '11111111'],
  I: ['11111111', '00111100', '00111100', '00111100', '00111100', '11111111'],
  O: ['01111110', '11000011', '11000011', '11000011', '11000011', '01111110'],
  S: ['01111111', '11000000', '01111110', '00000011', '00000011', '11111110'],
  K: ['11000011', '11000110', '11111100', '11111100', '11000110', '11000011'],
  A: ['01111110', '11000011', '11111111', '11111111', '11000011', '11000011'],
  N: ['11000011', '11100011', '11110011', '11011011', '11001111', '11000011'],
  B: ['11111110', '11000011', '11111110', '11111110', '11000011', '11111110'],
  '-': ['00000000', '00000000', '00111100', '00111100', '00000000', '00000000'],
} as const;
  ...
  WORDMARK.split('').forEach((char, letterIndex) => {
    ...
    glyph.forEach((row, rowIndex) => {
      ...
      const flushRun = (endColumn: number) => {
        ...
        segments.push(
          `M${x} ${y + CELL_HEIGHT}V${y}H${x + w}V${y + CELL_HEIGHT}Z`
        );
        runStart = null;
      };
